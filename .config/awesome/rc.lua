...
-- https://github.com/lcpz/dots/blob/master/bin/screenshot
  ...
  awful.key({ modkey, }, "e", function() awful.spawn.with_shell('surf ~/.surf/homepage/index.html') end),
...
awful.key({ }, "XF86AudioMute", function ()
    if muted then
        awful.spawn("pactl set-sink-mute @DEFAULT_SINK@ 0") -- Unmute and set volume to 10%
        muted = false -- Update state
    else
        awful.spawn("pactl set-sink-mute @DEFAULT_SINK@ 1") -- Mute
        muted = true -- Update state
    end
end),
...
awful.rules.rules = {
  ...
  -- Add remove to normal clients and dialogs
  {
